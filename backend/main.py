...
from backend.final_prompt import generate_final_verbose_prompt
...
@app.post("/analyze")
async def analyze_visibility(data: AnalysisInput):
    ...
    final_prompt = generate_final_verbose_prompt(
    ...
    for sk in semantic_keywords:
        ...
        visibility = await check_visibility(prompts, data.brand)
    ...
    return {
        ...
        "top_3_brands": top_3_overall,
        "final_verbose_prompt" : final_prompt,
        "details": all_results
    }
